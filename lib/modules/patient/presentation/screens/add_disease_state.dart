                          ...
                          : SingleChildScrollView(
                              child: Column(
                                children: [
                                  ...
                                  else if (controller.doctorsOfSelected?.data
                                          ?.isNotEmpty ??
                                      false)
                                    DropdownButtonFormField<String>(
                                      isExpanded: true,
                                      ...
                                      items:
                                          (controller.doctorsOfSelected?.data ??
                                                      [])
                                                  .map((d) =>
                                      ...
                                      validator: (val) {
                                        if (val == null || val.isEmpty) {
                                          return "الرجاء اختيار الطبيب المختص ";
                                        }
                                        return null;
                                      },
                                    ),
                                  ...
                                  AppTextFormField1(
                                    ...
                                    validator: (val) {
                                      if (val == null || val.isEmpty) {
                                        return "الرجاء ادخال الحالة المرضية  ";
                                      }
                                      return null;
                                    },
                                  ),
                                  ...
                                  AppTextFormField1(
                                    ...
                                    validator: (val) {
                                      if (val == null || val.isEmpty) {
                                        return "الرجاء اختيار المبلغ المتاح ";
                                      }
                                      return null;
                                    },
                                  ),
