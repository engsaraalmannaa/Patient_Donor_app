...
class LoginScreenPatient extends GetView<LoginController> {
  LoginScreenPatient({super.key,
  });
  static const name = '/lp';
  static final page = GetPage(
      name: name,
      page: () =>  LoginScreenPatient(),
...
/*AppButton(
                              ...
                              ontap: () async {
                               print("after valid");
                                if (formKey.currentState!.validate()) {
                                  print("test");
                                  log("youuuuuuuuuuuu aaaaaaaaaaaarrrrrrrrrrrreeeeeeeeeeeee");
                                  await controller.loginfunction();
                                    Get.offAllNamed(InformationScreen.name);
                                }
                              }
